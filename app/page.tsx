  ...
  return (
    <div className="mt-5">
      ...
      <div className="flex space-x-10  p-5 justify-center text-center items-center  ">
        <div className="shadow-xl shadow-gray-200 h-56 bg-white rounded-lg w-56  md:hidden lg:block">
          <Image
        ...
        <div className="shadow-xl shadow-gray-200 h-56 bg-white rounded-lg w-56 hidden md:block lg:block">
          <Image
